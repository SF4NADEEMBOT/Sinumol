...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'public bot ʟɪͥʏͭᴀᷤᴍᷟᴏͤʟ' : process.env.ALL_CAPTION,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'ʟɪͥʏͭᴀᷤᴍᷟᴏͤʟ' : process.env.BOT_NAME,
