...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'public bot SINU MOL' : process.env.ALL_CAPTION,
    ...
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'ꜱɪͥɴͭᴜᷤᴍᷟᴏͤʟ' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    BOTPLK: process.env.BOT_NAME === undefined ? 'ꜱɪͥɴͭᴜᷤᴍᷟᴏͤʟ' : process.env.BOT_NAME,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'FarooqSR4' : process.env.TAG_HEADER,
